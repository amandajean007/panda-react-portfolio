      ...
      <div id="projectLinks" class="content">
        ...
        <div class="paragraph">
          ...
          <a href="https://amandajean007.github.io/Password-Generator/" target="_blank" rel="noreferrer" id="1">
            <img alt="Password Generator" src={password} width="600px" height="auto"></img>
          </a>
        ...
        <div class="paragraph">
          ...
          <a href="https://amandajean007.github.io/Code-Quiz/" target="_blank" rel="noreferrer" id="2">
            <img class="photo" alt="Code Quiz" src={codequiz} width="600px" height="auto"></img>
          </a>
        ...
        <div class="paragraph">
          ...
          <a href="https://amandajean007.github.io/Work-Day-Scheduler/" target="_blank" rel="noreferrer" id="3">
            <img class="photo" alt="Work Day Scheduler" src={scheduler} width="600px" height="auto"></img>
          </a>
        ...
        <div class="paragraph">
          ...
          <a href="https://amandajean007.github.io/AAA/" target="_blank" rel="noreferrer" id="4">
            <img class="photo" alt="recipe generator" src={foodGenerator} width="600px" height="auto"></img>
          </a>
        ...
        <div class="paragraph">
          ...
          <a href="https://amandajean007.github.io/Weather-Tracker/ " target="_blank" rel="noreferrer" id="5">
            <img class="photo" alt="Weather Tracker" src={weather} width="600px" height="auto"></img>
          </a>
        ...
        <div class="paragraph">
          ...
          <a href="https://secure-crag-98297.herokuapp.com/login" target="_blank" rel="noreferrer" id="6">
            <img class="photo" alt="DinDin" src={dindin} width="600px" height="auto"></img>
          </a>
        ...
        <div class="paragraph">
          ...
          <a href="https://whispering-brushlands-45251.herokuapp.com/" target="_blank" rel="noreferrer" id="7">
            <img class="photo" alt="TechBlog" src={techblog} width="600px" height="auto"></img>
          </a>
        ...
        <div class="paragraph">
          ...
          <a href="https://safe-spire-01308.herokuapp.com/" target="_blank" rel="noreferrer" id="8">
            <img class="photo" alt="FitnessTracker" src={fitness} width="600px" height="auto"></img>
          </a>
        ...
        <div class="paragraph">
          ...
          <a href="https://panda-note-taker.herokuapp.com/" target="_blank" rel="noreferrer" id="9">
            <img class="photo" alt="NoteTaker" src={notetaker} width="600px" height="auto"></img>
          </a>
        ...
        <div class="paragraph">
          ...
          <a href="https://cryptic-tundra-70283.herokuapp.com/" target="_blank" rel="noreferrer" id="10">
            <img class="photo" alt="OfflineOnlineBudgetTracker" src={budget} width="600px" height="auto"></img>
          </a>
